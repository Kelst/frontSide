  ...
  <section className="mb-32 text-center md:text-left">
    ...
    <div className="mb-12 grid items-center gap-x-6 md:grid-cols-2 xl:gap-x-12">
      <div className="mb-6 md:mb-0">
        <div className="relative mb-6 overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20"
          data-te-ripple-init data-te-ripple-color="light" onClick={handleOpenDialog}>
      ...
      <div>
        <h3 className="mb-3 text-2xl font-bold">Lorem ipsum dolor. </h3>
        <div
        ...
        <p className="mb-6 text-neutral-500 dark:text-neutral-300">
          <small>Опубліковано <u>01.01.2022</u> by
    ...
    <div className="mb-12 grid items-center gap-x-6 md:grid-cols-2 xl:gap-x-12">
      ...
      <div className="md:order-1">
        <h3 className="mb-3 text-2xl font-bold">Lorem ipsum dolor sit amet</h3>
        <div
        ...
        <p className="mb-6 text-neutral-500 dark:text-neutral-300">
          <small>Опубліковано <u>10.02.2024</u> by
            <a href="#!"> Intelekt</a></small>
        </p>
        <p className="text-neutral-500 dark:text-neutral-300">
    ...
    <div className="mb-12 grid items-center gap-x-6 md:grid-cols-2 xl:gap-x-12">
      ...
      <div>
        ...
        <p className="mb-6 text-neutral-500 dark:text-neutral-300">
          <small>Опубліковано <u>10.01.2024</u> by
            <a href="#!">Intelekt</a></small>
        </p>
        <p className="text-neutral-500 dark:text-neutral-300">
...
<ArticleDialog open={openDialog} handleClose={()=>setOpenDialog(false)}/>
    </div>
  )
}
